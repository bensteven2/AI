...
tf.flags.DEFINE_string("image_address", "", "images_address")
tf.flags.DEFINE_string("dimensions_x", "", "dimensions_x")
tf.flags.DEFINE_string("dimensions_y", "", "dimensions_y")
tf.flags.DEFINE_string("pattern", "", "pattern")
